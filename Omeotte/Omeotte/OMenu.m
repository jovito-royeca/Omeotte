...
- (void)setup
{
    ...
    OButtonTexture *texture = [[OButtonTexture alloc] initWithWidth:200 height:50 cornerRadius:10 strokeWidth:2 strokeColor:0xFFFFFF gloss:NO startColor:0x0000FF endColor:0x0000FF];
...
{
    OBattle *battle = [[OBattle alloc] init];
